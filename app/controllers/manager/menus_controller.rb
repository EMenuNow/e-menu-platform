    ...
    def create
      ...
      respond_to do |format|
        if @menu.save
          ...
          @menu_time.save if params[:menu][:node_type] == "menu" && params[:menu_time][:timed_menu] == "1"
    ...
    def update
      ...
      respond_to do |format|
        if @menu.update(menu_params)
          ...
          params[:menu][:node_type] == "menu" && params[:menu_time][:timed_menu] == "1" ? @menu_time.update(menu_time_params) : @menu_time.destroy
